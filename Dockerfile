...
# docker build -t pixelhandler_blog .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name pixelhandler_blog pixelhandler_blog
...
# Install npm packages for Tailwind CSS plugins
RUN npm install
