...
published_at: '2010-11-11'
author: pixelhandler
tags: []
meta_description: "The purpose of this code is to test the behavior of the \n[.searchText()
  jQuery plugin](http://html-src.com/web-dev/71/searchtext-jquery-plugin-to-add-helper-..."
---

Each test will get values at different stages of user interaction with text
input field.
